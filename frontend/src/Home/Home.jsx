...
export default function Home() {
    ...
    function handleSubmit(e) {
        ...
        axios.post("https://hospital-application-vbhr.onrender.com/api/appointments/add", newAppointment)
            .then((res) => {
                console.log(res)
                if(res.status===201){
    ...
    async function fetchDoctors() {
        await axios.get("https://hospital-application-vbhr.onrender.com/api/doctors")
            .then((res) => {
